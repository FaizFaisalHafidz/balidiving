...
export default function Edit({ auth, campaign, categories }: EditCampaignPageProps) {
    const { data, setData, post, processing, errors } = useForm({
        judul: campaign.judul || '',
        deskripsi: campaign.deskripsi || '',
        kategori_id: campaign.kategori_id?.toString() || '',
        target_dana: campaign.target_dana?.toString() || '',
    ...
    const [imagePreview, setImagePreview] = useState<string | null>(
        campaign.gambar_utama ? `/storage/${campaign.gambar_utama}` : null
    );
        ...
        <AppLayout>
            ...
            <div className="p-6 space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-slate-900">Edit Kampanye</h1>
                        <p className="text-slate-600 mt-1">Update informasi kampanye</p>
                    </div>
                </div>
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <div className="flex justify-end gap-4">
                        ...
                        >
                            {processing ? 'Menyimpan...' : 'Update Kampanye'}
                        </Button>
                    </div>
                </form>
            </div>
