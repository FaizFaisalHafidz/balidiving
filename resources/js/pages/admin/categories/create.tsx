...
export default function CreateCategory({ auth }: { auth: { user: any } }) {
        ...
        <AppLayout>
            ...
            <div className="p-6 space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-slate-900">Tambah Kategori</h1>
                        <p className="text-slate-600 mt-1">Buat kategori kampanye baru</p>
                    </div>
                </div>
