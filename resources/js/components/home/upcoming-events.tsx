                      ...
                      <div className="flex-shrink-0">
                        ...
                        >
                          ...
                          <motion.div
                            ...
                            transition={{ duration: 0.6 }}
                          />
                          <div className="text-3xl font-bold relative z-10">{event.day}</div>
                          <div className="text-sm font-medium relative z-10">{event.month}</div>
                          <div className="text-xs opacity-90 relative z-10">{event.year}</div>
                        </motion.div>
                      </div>
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-3 text-sm text-gray-500 mb-4">
                          <div className="flex items-center gap-2 bg-gray-100 rounded-full px-3 py-1">
                            ...
                            <span>{event.day_name}, {event.start_time}</span>
                          </div>
                          {event.location && (
                            <div className="flex items-center gap-2 bg-gray-100 rounded-full px-3 py-1">
                        ...
                        {event.available_slots > 0 && (
                          <p className="text-sm text-green-600 mb-6">
                            {event.available_slots} slot{event.available_slots !== 1 ? 's' : ''} tersedia
                          </p>
                        )}
